$(document).ready(function () {
     ...
     */
    $(document).on("click", "#recognitionTable thead tr th:not(.no-sort)", function () {
        var table = $(this).parents("#recognitionTable");
        var rows = $(this).parents("#recognitionTable").find("tbody tr").toArray().sort(TableComparer($(this).index()));
    ...
    $('#recognitionTopTable .play_icon').first().trigger('click');
});