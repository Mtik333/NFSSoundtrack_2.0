 ...
 */
	 ...
	 */
	$(document).on("click", "#changelogTable thead tr th:not(.no-sort)", function () {
		var table = $(this).parents("#changelogTable");
		var rows = $(this).parents("#changelogTable").find("tbody tr").toArray().sort(TableComparer($(this).index()));
