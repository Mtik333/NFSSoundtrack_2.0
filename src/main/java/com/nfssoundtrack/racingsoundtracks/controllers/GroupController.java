...
public class GroupController extends BaseControllerWithErrorHandling {
    ...
    public @ResponseBody
    String gameGroupReadSubgroups(@PathVariable("gameId") int gameId) throws ResourceNotFoundException, JsonProcessingException {
        ObjectMapper objectMapper = new ObjectMapper();
        Game game = gameService.findById(gameId).orElseThrow(() -> new ResourceNotFoundException(NO_GAME_FOUND_WITH_ID + gameId));
    ...
    public @ResponseBody
    String gameGroupReadGroups(@PathVariable("gameId") int gameId) throws ResourceNotFoundException, JsonProcessingException {
        ObjectMapper objectMapper = new ObjectMapper();
        Game game = gameService.findById(gameId).orElseThrow(() -> new ResourceNotFoundException(NO_GAME_FOUND_WITH_ID + gameId));
        List<MainGroup> mainGroups = game.getMainGroups();
        SimpleModule simpleModule = new SimpleModule();
    ...
    public @ResponseBody
    String saveNewGroup(@PathVariable("gameId") int gameId, @RequestBody String formData) throws JsonProcessingException, ResourceNotFoundException {
    ...
    public @ResponseBody
    String putGroup(@PathVariable("groupId") int groupId, @RequestBody String formData) throws ResourceNotFoundException, JsonProcessingException {
        MainGroup mainGroup = mainGroupService.findById(groupId).orElseThrow(
    ...
    public @ResponseBody String putGroupPositions(@RequestBody String formData) throws JsonProcessingException, ResourceNotFoundException {
